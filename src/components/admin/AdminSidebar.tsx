...
import {
  ...
  GraduationCap, FileText, Landmark,
} from "lucide-react";
...
export default function AdminSidebar() {
  ...
  const allNavItems: NavItem[] = useMemo(
    () => [
      ...
      { key: "documents", href: `/${locale}/admin/documents`, icon: <FileText className="w-4.5 h-4.5" /> },
      { key: "governance", href: `/${locale}/admin/governance`, icon: <Landmark className="w-4.5 h-4.5" /> },
