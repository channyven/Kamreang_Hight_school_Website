...
/** Site settings may leave a social link unset; treat "#" as "no link". */
          ...
          <div className="lg:col-span-6">
            ...
            <div className="space-y-2.5 text-sm text-school-blue-200 mt-4">
              <a
                ...
                className="flex items-start gap-2 hover:text-school-gold-400 transition-colors duration-200 w-fit"
              >
              ...
              <a
                ...
                className="flex items-center gap-2 hover:text-school-gold-400 transition-colors duration-200 w-fit"
              >
            ...
            {/* Social */}
            {(hasLink(facebook) || hasLink(tiktok) || hasLink(youtube)) && (
              <div className="mt-5">
                <p className="text-xs font-semibold uppercase tracking-wider text-school-blue-300 mb-2.5">
                  {t("footer.follow_us")}
                </p>
