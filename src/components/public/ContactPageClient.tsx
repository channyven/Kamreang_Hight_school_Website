    ...
    <div className="min-h-screen bg-gray-50 pt-20">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 max-w-5xl mx-auto">
          ...
          >
            <h2
              className={`text-2xl font-bold text-gray-900 mb-6 ${locale === "km" ? "font-khmer" : ""
                }`}
            >
              {
                t("information_title")
            ...
            <div className="space-y-5 mb-8">
              {
                contactInfo.map((info) => (
                  ...
                  >
                    <div
                      className="w-10 h-10 rounded-xl bg-school-blue-50 flex items-center justify-center shrink-0"
                    >
                      {info.icon}
                    </div>
                    <div>
                      ...
                      <p
                        className={`font-medium text-gray-900 ${locale === "km" ? "font-khmer" : ""
                          }`}
                      >
                        {info.value}
