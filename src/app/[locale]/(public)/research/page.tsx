...
async function getSearchResults(
  ...
  // Sort: research areas & projects are static, keep them first when no date,
  // otherwise mix by date for news/achievements
  results.sort((a, b) => {
    // Items with dates sort by date desc
    if (a.date && b.date) {
          ...
          >
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                placeholder={
                  km
                    ? "ស្វែងរកព័ត៌មាន សមិទ្ធផល..."
                    : "Search news, achievements, announcements..."
                }
                aria-label={
